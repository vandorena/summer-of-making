      ...
      .then(data => {
        if (data.hackatime_setup) {
          ...
          this.iconTarget.innerHTML = `
            <svg class="w-5 h-5 text-green-600" xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
          ...
          this.iconTarget.innerHTML = `
            <svg class="w-5 h-5 text-yellow-600" xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'>
              <g fill='none' fill-rule='evenodd'>
